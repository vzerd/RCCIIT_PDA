...
function App() {
  ...
  const handleLogout=()=>{
    axios.post('https://ec2-13-127-22-223.ap-south-1.compute.amazonaws.com:8097/api/v1/auth/sign_out', {
  ...
  const handleLogin = () => {
    axios.post('https://ec2-13-127-22-223.ap-south-1.compute.amazonaws.com:8097/api/v1/auth/sign_in', {
      "password" : password
    })
    .then(function (response) {
